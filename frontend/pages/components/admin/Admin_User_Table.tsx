...
export default function StickyHeadTable() {
  ...
  const handleOnchangeForm = (event : any ) => {
...
<label className="  my-3  input input-bordered flex items-center gap-2">\
  ...
  <input onChange={handleOnchangeForm} value={formData.name} type="name"  placeholder="Username" />
...
<label className=" my-3 input input-bordered flex items-center gap-2">
  ...
  <input type="password"  placeholder="Password"   className="grow"/>
          ...
          <button onClick={handleSubmit} className="btn btn-info text-white">Submit</button>
